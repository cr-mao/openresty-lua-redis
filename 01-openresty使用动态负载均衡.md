...
注册 2台 应用层 nginx
```shell  
curl -X PUT -d '{"weight":1,"max_fails":2,"fail_timeout":10}' http://127.0.0.1:8700/v1/kv/upstreams/servers/192.168.1.9:8002
curl -X PUT -d '{"weight":1,"max_fails":2,"fail_timeout":10}' http://127.0.0.1:8700/v1/kv/upstreams/servers/192.168.1.10:8003
```
...
```
upstream servers {
server 192.168.1.9:8002 max_fails=3 fail_timeout=5s;
